...
-- ============================================================
-- SETUP TABS (dengan ikon Unicode rapi, tanpa emoji)
-- ============================================================
...
local function getCrystalRarity(child)
    ...
    if tier > 0 and tier <= #ASTRO.State.rarityList then
        return ASTRO.State.rarityList[tier]
    end
    -- jika tidak ada attribute tier, anggap Common (tier 1)
    return "Common"
end
