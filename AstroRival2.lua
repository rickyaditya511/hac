...
local function SetupVisuals()
    ...
    local function applyThirdPerson()
        if VIS.Thirdperson then
            ...
            lp.CameraMode = Enum.CameraMode.LockFirstPerson        end
    end
...
function ASTRO:Init()
    ...
    -- FOV Circles
    local function setupFovCircles()
        local state = ASTRO.State
        state.FovCircles.SA.bg = Drawing.new("Circle")
        state.FovCircles.SA.bg.Thickness = 0; state.FovCircles.SA.bg.Filled = true; state.FovCircles.SA.bg.Transparency = 0.4
        state.FovCircles.SA.ring = Drawing.new("Circle")
        state.FovCircles.SA.ring.Thickness = 1.5; state.FovCircles.SA.ring.Filled = false; state.FovCircles.SA.ring.Transparency = 0.8
        state.FovCircles.Rage.bg = Drawing.new("Circle")
        state.FovCircles.Rage.bg.Thickness = 0; state.FovCircles.Rage.bg.Filled = true; state.FovCircles.Rage.bg.Transparency = 0.4
        state.FovCircles.Rage.ring = Drawing.new("Circle")
        state.FovCircles.Rage.ring.Thickness = 1.5; state.FovCircles.Rage.ring.Filled = false; state.FovCircles.Rage.ring.Transparency = 0.8
        state.FovCircles.Hold.bg = Drawing.new("Circle")
        state.FovCircles.Hold.bg.Thickness = 0; state.FovCircles.Hold.bg.Filled = true; state.FovCircles.Hold.bg.Transparency = 0.4
        state.FovCircles.Hold.ring = Drawing.new("Circle")
        state.FovCircles.Hold.ring.Thickness = 1.5; state.FovCircles.Hold.ring.Filled = false; state.FovCircles.Hold.ring.Transparency = 0.8
    end

    local function updateFovCircles()
        local state = ASTRO.State
        local mouse = ASTRO.Services.UserInputService:GetMouseLocation()
        local SA = ASTRO.Features.SilentAim
        local RB = ASTRO.Features.RageBot
    ...
    setupFovCircles()
    ASTRO.Services.RunService.RenderStepped:Connect(updateFovCircles)
    ...
    SaveManager:SetLibrary(ASTRO.Library)
